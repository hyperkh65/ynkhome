          ...
          <div style={{ flex: 1, padding: '18px', display: 'flex', flexDirection: 'column', gap: '14px', overflow: 'hidden' }}>
            ...
            <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '280px 1fr 280px', gap: '14px', overflow: 'hidden' }}>
              ...
              <div style={{ background: 'white', borderRadius: '14px', padding: '18px', border: '1px solid #d2d2d7', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ flex: 1, overflowY: 'auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px', padding: '4px' }}>
                  {catalogData.slice(0, 12).map(p => (
                    ...
                    >
                      <img
                        ...
                        onError={(e) => e.target.src = 'https://picsum.photos/400/300?blur=5'}
                      />
                      <div style={{
                        position: 'absolute',
                        bottom: 0,
                        ...
                        <div style={{ fontSize: '0.6rem', color: 'rgba(255,255,255,0.8)', marginTop: '2px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {p.specs?.modelName || 'YNK Series'}
                        </div>
                      </div>
                    </div>
                  ))}
